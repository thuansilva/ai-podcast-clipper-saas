...
export function Footer() {
  return (
    <footer className="border-t border-[var(--linha)] bg-[#0b0a08] py-12 text-[var(--fumaca)]">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
          <div className="flex items-center gap-2">
            <div className="flex h-6 w-6 items-center justify-center rounded-full border border-[var(--ouro)]/40 bg-[#161310] shadow-[0_0_10px_rgba(232,186,82,0.15)]">
