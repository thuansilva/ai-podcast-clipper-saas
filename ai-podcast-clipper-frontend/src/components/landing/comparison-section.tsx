...
export function ComparisonSection() {
  ...
  return (
    <section id="comparison" className="border-t border-[var(--linha)] py-20 bg-[var(--tinta)]">
      <div className="mx-auto max-w-5xl px-4 sm:px-6">
        ...
        <div className="mt-12 overflow-hidden rounded-xl border border-[var(--linha)] bg-[var(--superficie)] shadow-[0_0_30px_rgba(0,0,0,0.5)]">
          <div className="grid grid-cols-1 md:grid-cols-12 border-b border-[var(--linha)] bg-[var(--superficie-2)] p-4 font-mono text-xs text-[var(--fumaca)]">
          ...
          <div className="divide-y divide-[var(--linha)]">
            {comparisons.map((item, idx) => (
              <div key={idx} className="grid grid-cols-1 md:grid-cols-12 p-4 text-sm gap-2 md:gap-0 items-center hover:bg-[var(--superficie-2)]/50 transition-colors">
